...
public class SchematicIO {
    ...
    public SchematicData loadSchematic(String name) {
        ...
        return new SchematicData(blocks, origin, creator);
    }
    ...
    public static class SchematicData {
        ...
        public SchematicData(Map<String, BlockData> blocks, Location origin, String creator) {
            this.blocks = blocks;
            this.origin = origin;
